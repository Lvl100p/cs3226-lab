                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('nickname') ? ' has-error' : '' }}">
                            <label for="nickname" class="col-md-4 control-label">Kattis Nickname</label>
                        ...
                        <div class="form-group{{ $errors->has('flag') ? ' has-error' : '' }}">
                            <label for="flag" class="col-md-4 control-label">Nationality</label>

                            <div class="col-md-6">
                                <select  id="flag"  name="flag" class="js-example-basic-single" value="{{ old('flag') }}" required autofocus>
